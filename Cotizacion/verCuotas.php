...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="2" width="440">
		<tr>
		<td class="pageName">Ver Cuotas</td>
		</tr>
	...
	<tr>
		...
		?>
	     ...
	     <form id="form2" name="form2" method="post" action="VerCuotas.php">
			 <table border="0">
				<tr>
    ...
    if(@$botonConsultar)	
         {
		  $arreglo = $obt->obtenerTodosConCuotas($areaSeleccionada, $tipoSeleccionado);
		  $obtTipo = $obtTipo->obtenerPorId($tipoSeleccionado);
		  $nombreTipo = $obtTipo->nombre;
         }		 
    else
		 {
		  $arreglo = $obt->obtenerTodosConCuotas(0, 1);
  ...
  echo "<tr><th  colspan='2'>Saldo Total:</th> <th> <i> $saldoTotal CUP</i></th></tr>";	   
  echo "<tr><th class='header' colspan='3'>Total: <i> $cantEle elementos </i></th></tr>";		 
  echo "</table>";   
