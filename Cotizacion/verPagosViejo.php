...
<th class='header'>$nombreTipo (Cuota)</th>
							...
							echo "<tr><th  colspan='2'>Saldo Total:</th><th> <i> $saldoTotalPagado CUP</i><p>($num %)</p></th> <th> <i> $saldoTotal CUP</i></th></tr>";
							echo "<tr><th class='header' colspan='4'>Total: <i> $cantEle elementos </i></th></tr>";
							echo "</table>";
							?>
