...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		?>
	     ...
	     <form id="form2" name="form2" method="post" action="efectuarPago.php">
			<table border="0">
				<tr>
	...
	<form id="form5" name="form5" method="post" action="incluirPago.php"> 
      <?php	 
    ...
    if(@$botonConsultar)	
         {
		  $arreglo = $obt->consultarPorArea($areaSeleccionada);
         }		 
    else
		 {
 ...
 ?>
	...
	<td class="smallText">
	 <?php 
	  ...
	  <tr>
	<td class="smallText">Transacción</td>
	<td class="smallText">
	 <?php 
