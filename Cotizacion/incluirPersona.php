...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="2" width="440">
		<tr>
		<td class="pageName">Insertar Persona</td>
		</tr>

		<tr>
		<td class="bodyText">
		<?php
			require('viewInsertarPersona.php');
			if($botonIncluir)
			{
				  $persona = new CPersona();
				  $persona->nombre = $textfield;
				  $persona->apellido = $textfield1;
				  $persona->area = $areaSeleccionada;				  
				  $fechaInici = new CFecha();
				  $fechaInici->d = date("d");
				  $fechaInici->m = date("m");
				  $fechaInici->a = date("y");
				  $persona->fechaAlta = $fechaInici;
				  $persona->salvar();
			}
		 ?>
